      ...
      <Space direction="vertical">
        ...
        <Space>
          ...
          <Input
            ...
            onChange={(e) => {
              setAttributeModel(e.target.value);
            }}
          ></Input>
        </Space>
        <Space>
          ...
          <Space direction="vertical">
            <Space direction="vertical">
              ...
              <Space>
                <label>Upper:</label>
                <Input
                  value={chargeForCurrentUpper}
                  onChange={(e) => {
                    setChargeForCurrentUpper(e.target.value);
                  }}
                ></Input>
              </Space>
              <Space>
                <label>Lower:</label>
                <Input
                  value={chargeForCurrentLower}
                  onChange={(e) => {
                    setChargeForCurrentLower(e.target.value);
                  }}
                ></Input>
              </Space>
            </Space>
            ...
            <Space direction="vertical">
              ...
              <Space>
                <label>Upper:</label>
                <Input
                  value={alertSettingTempUpper}
                  onChange={(e) => {
                    setAlertSettingTempUpper(e.target.value);
                  }}
                ></Input>
              </Space>
              <Space>
                <label>Lower:</label>
                <Input
                  value={alertSettingTempLower}
                  onChange={(e) => {
                    setAlertSettingTempLower(e.target.value);
                  }}
                ></Input>
              </Space>
            </Space>
            ...
            <Space direction="vertical">
              ...
              <Space>
                <label>Max:</label>
                <Input
                  value={chargeVoltageMax}
                  onChange={(e) => {
                    setChargeVoltageMax(e.target.value);
                  }}
                ></Input>
              </Space>
            </Space>
          ...
          <Space direction="vertical">
            ...
            <Space direction="vertical">
              ...
              <Space>
                <label>Upper:</label>
                <Input
                  value={dischargeForCurrentUpper}
                  onChange={(e) => {
                    setDischargeForCurrentUpper(e.target.value);
                  }}
                ></Input>
              </Space>
              <Space>
                <label>Lower:</label>
                <Input
                  value={dischargeForCurrentLower}
                  onChange={(e) => {
                    setDischargeForCurrentLower(e.target.value);
                  }}
                ></Input>
              </Space>
            </Space>
            ...
            <Space direction="vertical">
              ...
              <Space>
                <label>Upper:</label>
                <Input
                  value={dischargeTempUpper}
                  onChange={(e) => {
                    setDischargeTempUpper(e.target.value);
                  }}
                ></Input>
              </Space>
              <Space>
                <label>Lower:</label>
                <Input
                  value={dischargeTempLower}
                  onChange={(e) => {
                    setDischargeTempLower(e.target.value);
                  }}
                ></Input>
              </Space>
            </Space>
            ...
            <Space direction="vertical">
              ...
              <Space>
                <label>Max:</label>
                <Input
                  value={dischargeVoltageMax}
                  onChange={(e) => {
                    setDischargeVoltageMax(e.target.value);
                  }}
                ></Input>
              </Space>
            </Space>
